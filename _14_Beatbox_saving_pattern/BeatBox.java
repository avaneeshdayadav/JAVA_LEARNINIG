...
// Import this for saving and restoring data from file (file handling)
import java.io.*;
...
public class BeatBox{
	...
	public void buildGUI()
	{
		...
		JButton serialize = new JButton("Serialize It");			// Make a button that will save checkbox pattern.
		serialize.addActionListener(new MySendListener());
		buttonBox.add(serialize);


		JButton restore = new JButton("Restore");					// Make a button that will load a saved checkbox pattern.
	...
	*/
	...
	// Code that stores and restores the pattern.

		// Inner class that stores the current checkbox pattern.
		...
		// Inner class that loads stored checkbox pattern.
	...
	// Code that stores and restores the pattern end.
